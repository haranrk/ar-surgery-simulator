...
namespace GoogleARCore.Examples.CloudAnchors
{
    ...
    public class CloudAnchorController : MonoBehaviour
    {
        ...
        ORMultiSceneController mainControllerScript;
        /// <summary>
        ...
        public void Start()
        {   
            mainControllerScript = mainController.GetComponent<ORMultiSceneController>();
        ...
        public void Update()
        {
            ...
            if (m_LastPlacedAnchor != null)
            {
                ...
                mainControllerScript.ORSetup(m_LastPlacedAnchor.transform);
                // Save cloud anchor.
