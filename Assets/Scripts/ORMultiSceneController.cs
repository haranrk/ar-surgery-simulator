...
public class ORMultiSceneController : MonoBehaviour {
	public GameObject OperationTheaterPrefab;
	...
	void ORSetup(){
		...
		if (Frame.Raycast(touch.position.x, touch.position.y, rayCastFilter, out hit)){
			...
			OperationTheater = Instantiate(OperationTheaterPrefab);
	...
	public void ORSetup(Transform anchorTransform){
		OperationTheater = Instantiate(OperationTheaterPrefab);
		placeOR(anchorTransform);
	}

	public void placeOR(Transform anchorTransform){
		OperationTheater.transform.position = anchorTransform.position + GroundOffsetVector;
		OperationTheater.transform.SetParent(anchorTransform);
		SetupCompleted = true;		
	}

	public void deactivateOR(){
		SetupCompleted = false;
		OperationTheater.SetActive(false);
		OperationTheater.transform.parent = null;
	}
